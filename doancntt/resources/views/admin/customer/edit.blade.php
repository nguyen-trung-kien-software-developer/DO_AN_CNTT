        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Chỉnh sửa khách hàng có mã <span
                            style="color: red;">#{{ $customer->id }}</span></h4>
                </div>
                <div class="card-body">
                    <div class="basic-form">
                        <form class="form-valide-with-icon" action="{{ route('admin.customer.update', $customer->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="val-username1" name="mobile"
                                        placeholder="Số điện thoại.." value="{{ $customer->mobile }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" id="val-username1" name="password"
                                        placeholder="Mật khẩu.." value="{{ $customer->password }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="val-username1" name="shipping_name"
                                        placeholder="Họ và tên người nhận.." value="{{ $customer->shipping_name }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="val-username1" name="shipping_mobile"
                                        ...
                                        value="{{ $customer->shipping_mobile }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="val-username1" name="housenumber_street"
                                        value="{{ $customer->housenumber_street }}" placeholder="Số nhà, tên đường..">
                                </div>
                                ...
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="is_active" class="form-check-input" value="1"
                                            {{ $customer->is_active == 1 ? 'checked' : '' }}>Kích
                                        hoạt
                                    </label>
                                </div>
                            </div>

        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Chỉnh sửa thương hiệu có mã <span
                            style="color: red;">#{{ $brand->id }}</span>
                    </h4>
                </div>
                <div class="card-body">
                    <form class="form-valide-with-icon" action="{{ route('admin.brand.update', $brand->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="description" rows="10"
                                cols="80">{{ $brand->description }}</textarea>
